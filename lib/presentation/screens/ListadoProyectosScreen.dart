...
class _ListadoProyectosScreenState extends State<ListadoProyectosScreen> {
    ...
    return Column(
      ...
      children: [
        ...
        if (_controller.isLoading)
          const Center(
            child: CircularProgressIndicator(color: Color(0xFF1046C4)),
          )
        else if (_controller.proyectosFiltrados.isEmpty &&
            _controller.searchQuery.isEmpty)
          _buildEstadoVacio(
            mensaje: "No hay proyectos guardados en el sistema.",
          )
        else if (_controller.proyectosFiltrados.isEmpty)
          _buildEstadoVacio(
            mensaje:
                'No se encontraron resultados para "${_controller.searchQuery}".',
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double montoPendiente = _controller.calcularMontoPorCobrar(
                datosCompletos,
              );
              ...
              final String empresa =
                  datosCompletos['empresacontratante'] ?? 'Sin Empresa';
              final int iconoCode =
                  datosCompletos['icono'] ?? Icons.science.codePoint;

              String fechaFormateada = "Sin fecha";
              if (datosCompletos['fechaInicio'] != null) {
                DateTime fecha = (datosCompletos['fechaInicio'] as Timestamp)
                    .toDate();
                fechaFormateada =
  ...
  Widget _buildHeader() {
    return Column(
      ...
      children: [
        ...
        Text(
          "Gestione y supervise todas las investigaciones activas.",
      ...
      child: Flex(
        ...
        children: [
          Flexible(
            ...
            child: TextField(
              onChanged:
                  _controller.actualizarBusqueda, // 👉 Directo al cerebro
  ...
  Widget _buildEstadoVacio({
    ...
    IconData icono = Icons.folder_open,
  }) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: const Color(0xFFD6DDF0)),
      ),
      child: Column(
        children: [
  ...
  Widget _buildProjectCardWeb({
    ...
    required double montoPorCobrar,
    required Map<String, dynamic> datosCompletos,
  }) {
    double progress = _controller.calcularProgreso(
      datosCompletos,
      ...
      child: Row(
        children: [
              ...
              children: [
                Row(
                  children: [
                    ...
                    InkWell(
                      onTap: () => _confirmarEliminacion(datosCompletos),
                      borderRadius: BorderRadius.circular(20),
                      child: Padding(
                        padding: const EdgeInsets.all(4.0),
                        child: Icon(
                ...
                Row(
                  children: [
                    ...
                    Text(
                      "Por cobrar: \$${montoPorCobrar.toStringAsFixed(2)}",
                      style: TextStyle(
                        fontSize: 13,
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor: widget.esModoSeguimiento
                  ? const Color(0xFF1046C4)
                  : const Color(0xFFEEF2FF),
              foregroundColor: widget.esModoSeguimiento
                  ? Colors.white
                  : const Color(0xFF1046C4),
            ),
            child: Text(
              widget.esModoSeguimiento
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              icon: Icon(
                widget.esModoSeguimiento ? Icons.analytics : Icons.add_task,
                size: 20,
              ),
              label: Text(
                widget.esModoSeguimiento
